        ...
        <section className='mt-[440px] md:mt-[640px] lg:mt-[850px]'>
          <div className="content-left mt-8">
            <p className='content-medium post-paragraph'>
              ...
              asesorándolos desde los principios fundamentales de la experiencia de usuario (UI/UX) para asegurar
              que
              el resultado final no solo fuera <span className="highlight">visualmente atractivo</span>, sino
              también
        ...
        <section className='mt-64'>
          ...
          <div className="content-center mt-5">
            ...
            >
              ...
              y sindicatos en busca de soluciones estratégicas) y <span
              className="highlight">generar una confianza palpable </span> en
